...
export default class SearchForm extends React.Component {
        ...
        (result) => {
          if (result) {
            ...
            result[0].forEach((element) => {
              if ("attributes" in element && element.attributes != null) {
                if ("firstName" in element.attributes) {
                  if (element.attributes.firstName) {
                    names.push(element);
                  }
                }
              }
      ...
      .then(
        (result) => {
          ...
          result[0].forEach((element) => {
            if ("attributes" in element && element.attributes != null) {
              if (
                "isClass" in element.attributes &&
                element.attributes.isClass &&
                "name" in element &&
                "classmemberids" in element.attributes
              ) {
        ...
        (result) => {
          ...
          result[0].forEach((element) => {
            if ("attributes" in element && element.attributes != null) {
              if (
                "isClass" in element.attributes &&
                element.attributes.isClass == false &&
                "name" in element
              ) {
                if (
                  element.name
  ...
  getProfilePic = (dict) => {
    if (
      "profilePicture" in dict.attributes &&
      dict.attributes.profilePicture != ""
    ) {
    ...
    this.state.users.map((dict) => {
      if (dict.id == ids) {
        if ("profilePicture" in dict.attributes) {
          profilepic =
            "https://webdev.cse.buffalo.edu" + dict.attributes.profilePicture;
        } else {
          profilepic =
            "https://webdev.cse.buffalo.edu/hci/api/uploads/files/DOo1Ebbt8dYT4-plb6G6NP5jIc9_l_gNlaYwPW4SaBM.png";
        }
          ...
          <div className={styles.fixseekers}>
            ...
            <div id="filter" className={styles.maincontainer}>
                      ...
                      <div key={dict} className={styles.content}>
                        <div className={styles.outtercontent1}>
                          ...
                          <div className={styles.innercontent1}>
                            <p className={styles.size3}>
                              {dict.attributes.firstName +
                                " " +
                                dict.attributes.lastName}
                            </p>
                            {"rating" in dict.attributes &&
                              dict.attributes.rating == 0 && (
                                <div className={styles.stars}>
                                  <img
                                    className={styles.star1}
                                    src={starIcon}
                                  ...
                                  <img
                                    ...
                                    alt="star"
                                  />
                                  <p className={styles.size8}>
                                    ({dict.attributes.rating})
                                  </p>
                                </div>
                              )}
                            {"rating" in dict.attributes &&
                              dict.attributes.rating == 1 && (
                                <div className={styles.stars}>
                                  <img
                                    className={styles.star1}
                                    src={starIconLit}
              ...
              {!this.state.userFound && (
                <div>
                  <p>
                    <i>No students matching "{this.state.nextUserInput}"</i>{" "}
                  </p>
                </div>
              )}
            </div>
            ...
            <div id="filter" className={styles.maincontainer}>
                    ...
                    <div className={styles.background4}>
                      <div key={dict} className={styles.content2}>
                        <div className={styles.outtercontent4}>
                          ...
                          <p className={styles.headersize}>
                            University at Buffalo
                          </p>
                          <p className={styles.headersize}>
                            {dict.attributes.classmemberids.length +
                              " students"}
                          </p>
                        </div>
                        ...
                        <div className={styles.outtercontent5}>
                          ...
                          {dict.attributes.classmemberids.length > 0 &&
                            dict.attributes.classmemberids.length == 2 && (
                          ...
                          {dict.attributes.classmemberids.length > 0 &&
                            dict.attributes.classmemberids.length == 3 && (
                              <div className={styles.innercontent5}>
                                <img
                                  className={styles.picturecircle1}
                                  src={this.getProfilePic2(
                            ...
                            dict.attributes.classmemberids.length != 3 && (
                              <div className={styles.innercontent5}>
                                ...
                                <img
                                  className={styles.picturecircle1}
                                  src={this.getProfilePic2(
                                    dict.attributes.classmemberids[
                                      dict.attributes.classmemberids.length - 1
                                    ]
                                  )}
                                />
              ...
              {!this.state.classFound && (
                <div>
                  <p>
                    <i>No classes matching "{this.state.nextUserInput}"</i>{" "}
                  </p>
                </div>
              )}
            </div>
            ...
            <div id="filter" className={styles.maincontainer}>
                    ...
                    <div className={styles.background2}>
                      <div key={dict} className={styles.content3}>
                        <div className={styles.outtercontent4}>
                          ...
                          <p className={styles.size6}>
                            {dict.name}
                            <br />
                            <div className={styles.size7}>
                              {this.getClassName(dict)}
                            </div>
                          </p>
                          <p className={styles.headersize}>
                            University at Buffalo
                          ...
                          <p className={styles.headersize}>
                            {dict.attributes.members.length + " students"}
                          </p>
                        </div>
                        <div className={styles.outtercontent5}>
                          ...
                          {dict.attributes.members.length > 0 &&
                            dict.attributes.members.length == 2 && (
                              <div className={styles.innercontent5}>
                                <img
                                  className={styles.picturecircle1}
                                  src={this.getProfilePic2(
                          ...
                          {dict.attributes.members.length > 0 &&
                            dict.attributes.members.length == 3 && (
                              <div className={styles.innercontent5}>
                                <img
                                  className={styles.picturecircle1}
                                  src={this.getProfilePic2(
              ...
              {!this.state.groupFound && (
                <div>
                  <p>
                    <i>No groups matching "{this.state.nextUserInput}"</i>{" "}
                  </p>
                </div>
              )}
            </div>
