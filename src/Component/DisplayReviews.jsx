...
export default class ClassPosts extends Component {
  ...
  getStar(rating){
    ...
    if (rating==1){this.setState({star:[litStar,starIcon,starIcon,starIcon,starIcon]});}
    else if (rating==2){this.setState({star:[litStar,litStar,starIcon,starIcon,starIcon]});}
    else if (rating==3){this.setState({star:[litStar,litStar,litStar,starIcon,starIcon]});}
    else if (rating==4){this.setState({star:[litStar,litStar,litStar,litStar,starIcon]});}
    else if (rating==5){this.setState({star:[litStar,litStar,litStar,litStar,litStar]});}
    else {this.setState({star:[starIcon,starIcon,starIcon,starIcon,starIcon]});}
  }
                ...
                {"review" in post.attributes && post.attributes.review &&(
                  <>
                    <div className={styles.maincontainer}>
                      <div>
                        <div className={styles.stars}>
                                      ...
                                      {post.attributes.rating==1 && (
                                        <>
                                        <img className={styles.star1}  src={litStar} alt="star"/>
                                        <img className={styles.star2}  src={starIcon} alt="star"/>
                                        <img className={styles.star3}  src={starIcon} alt="star"/>
                                        <img className={styles.star4}  src={starIcon} alt="star"/>
                                        <img className={styles.star5}  src={starIcon} alt="star"/>
                                      ...
                                      {post.attributes.rating==2 && (
                                        <>
                                        <img className={styles.star1}  src={litStar} alt="star"/>
                                        <img className={styles.star2}  src={litStar} alt="star"/>
                                        <img className={styles.star3}  src={starIcon} alt="star"/>
                                        <img className={styles.star4}  src={starIcon} alt="star"/>
                                        <img className={styles.star5}  src={starIcon} alt="star"/>
                                        </>
                                      ...
                                      {post.attributes.rating==3 && (
                                        ...
                                        <img className={styles.star1}  src={litStar} alt="star"/>
                                        <img className={styles.star2}  src={litStar} alt="star"/>
                                        <img className={styles.star3}  src={litStar} alt="star"/>
                                        <img className={styles.star4}  src={starIcon} alt="star"/>
                                        <img className={styles.star5}  src={starIcon} alt="star"/>
                                        </>
                                      )}
                                      {post.attributes.rating==4 && (
                                        ...
                                        <img className={styles.star2}  src={litStar} alt="star"/>
                                        <img className={styles.star3}  src={litStar} alt="star"/>
                                        <img className={styles.star4}  src={litStar} alt="star"/>
                                        <img className={styles.star5}  src={starIcon} alt="star"/>
                                        </>
                                      )}
                                      {post.attributes.rating==5 && (
                                        ...
                                        <img className={styles.star3}  src={litStar} alt="star"/>
                                        <img className={styles.star4}  src={litStar} alt="star"/>
                                        <img className={styles.star5}  src={litStar} alt="star"/>
                                          </>
                                      )}
                      ...
                      <div>
                        <img src={"https://webdev.cse.buffalo.edu" + post.author.attributes.profilePicture} className={styles.picturecircle}></img>
                      </div>
                      <div >
                        <p className={styles.textsize} >{post.author.attributes.firstName} {post.author.attributes.lastName}</p>
                        <p className={styles.reviewsize}><i>{'"'+post.content+'"'}</i></p>
                      </div>
                                        
                    </div>
                    <div className={styles.innercontent}>
                      <div className={styles.innercontent2}>
                        <img className={styles.uparrow} src={uparrow} alt="uparrow"/>
                        <p>0</p>
                      </div>
                      <div className={styles.innercontent2}>
                        <p>0</p>
                        <img className={styles.uparrow} src={downarrow} alt="downarrow"/>
                      </div>
                    </div>
                  </>
                )}
