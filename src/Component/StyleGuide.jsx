      ...
      return (
        <div >
            ...
            <div className="box2">
                ...
                <div className="size1">Heading 1<p className="size8">70px - Landing page logo</p></div>
                <div className="size2">Heading 2<p className="size8">48px - Login page logo</p></div>
                <div className="size3">Heading 3<p className="size8">36px - Navigation bar text</p></div>
                <div className="size4">Text in 30px<p className="size8">30px - Title</p></div>
                <div className="size5">Text in 24px<p className="size8">24px - Text</p></div>
                <div className="size6">Text in 18px<p className="size8">18px - Tagline</p></div>
                <div className="size7">Text in 14px<p className="size8">14px - Help / guideline</p></div>
                <div><h1 className="size9">h1 Heading</h1><p className="size8">h1 - Profile name</p></div>
            </div>
            </td>
            <tr>
            <td>
            ...
            <div className="box5">
                <h3 className="text">Buttons</h3>
                        <button className="connectButton">Button 1</button><p className="size10"> Connect / Submit button</p>
